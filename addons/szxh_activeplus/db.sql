...
CREATE TABLE IF NOT EXISTS `ims_szxh_activeplus` (
  ...
  `princ` varchar(32) NOT NULL DEFAULT '' COMMENT '校长wechat_id',
  `princ_reward` double(10,2) NOT NULL DEFAULT '0.00' COMMENT '校长返利',
...
CREATE TABLE IF NOT EXISTS `ims_szxh_activeplus_cate` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `create_time` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=62 DEFAULT CHARSET=utf8 COMMENT='szxh:活动分类';


CREATE TABLE IF NOT EXISTS `ims_szxh_activeplus_giftlog` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `active_id` int(11) NOT NULL,
  `new_gift_name` varchar(80) NOT NULL,
  `new_gift_num` int(11) NOT NULL,
  `old_gift_name` varchar(80) NOT NULL,
  `old_gift_num` int(11) NOT NULL,
  `ex_name` varchar(30) NOT NULL COMMENT '物流公司',
  `ex_sn` varchar(30) NOT NULL COMMENT '物流单号',
  `create_time` int(11) NOT NULL COMMENT '发货时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=207 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;


CREATE TABLE IF NOT EXISTS `ims_szxh_activeplus_order` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `active_title` varchar(100) NOT NULL DEFAULT '',
  `order_sn` varchar(20) CHARACTER SET utf8mb4 NOT NULL COMMENT '订单号',
...
) ENGINE=InnoDB AUTO_INCREMENT=29236 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='活动报名表';


CREATE TABLE IF NOT EXISTS `ims_szxh_activeplus_register` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `active_id` int(11) NOT NULL,
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='活动报名表';


CREATE TABLE IF NOT EXISTS `ims_szxh_activeplus_robot` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ims_szxh_activeplus_robot_bind` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `bind_id` int(11) NOT NULL COMMENT '关联主表ID',
  `addon` varchar(30) NOT NULL COMMENT '模块名',
  `tablename` varchar(30) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='机器人绑定表';


CREATE TABLE IF NOT EXISTS `ims_szxh_activeplus_service_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
  `uid` int(11) NOT NULL COMMENT '操作员ID',
  ...
  `create_time` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=93 DEFAULT CHARSET=utf8 COMMENT='客服';
...
CREATE TABLE IF NOT EXISTS `ims_szxh_activeplus_sharelog` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='分享次数记录：可能不准确，以分享回调记录为主';


CREATE TABLE IF NOT EXISTS `ims_szxh_activeplus_transfers` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
  `type` tinyint(1) NOT NULL DEFAULT '1' COMMENT '1企业付款 2单人红包',
  `active_id` int(11) NOT NULL DEFAULT '0',
  `send_type` tinyint(1) NOT NULL DEFAULT '0' COMMENT '1推荐 2分享 3校长',
  ...
  `params` text,
  `reward_msg` varchar(50) NOT NULL COMMENT '发放结果通知',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=20617 DEFAULT CHARSET=utf8 COMMENT='奖金记录';


CREATE TABLE IF NOT EXISTS `ims_szxh_activeplus_view` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `active_id` int(11) NOT NULL COMMENT '活动ID',
  `wechat_id` varchar(64) NOT NULL COMMENT '微信ID',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=206605 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='查看活动用户记录，根据时间记录，新纪录者增加活动浏览数1,120分钟内相同用户不记录';
...
CREATE TABLE IF NOT EXISTS `ims_szxh_config` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='szxh模块控制';
...
CREATE TABLE IF NOT EXISTS `ims_szxh_log` (
  ...
  `create_time` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=194 DEFAULT CHARSET=utf8 COMMENT='后台测试用';
