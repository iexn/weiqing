...
function img2base64(imageSelector, imageprop) {
    ...
    imgresource.src = $(imageSelector).attr(imageprop) || $(imageSelector).prop('src');
    imgresource.onload = function () {
        if (imageprop) {
            $(imageSelector).prop('src', 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsQAAA7EAZUrDhsAAAANSURBVBhXYzh8+PB/AAffA0nNPuCLAAAAAElFTkSuQmCC').hide();
        }
