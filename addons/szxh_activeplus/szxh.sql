...
CREATE TABLE IF NOT EXISTS `ims_szxh_activeplus_cate` (
  ...
  `create_time` int(11) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8 COMMENT='szxh:活动分类';
...
) ENGINE=MyISAM AUTO_INCREMENT=3320 DEFAULT CHARSET=utf8 COMMENT='活动报名表';
...
CREATE TABLE IF NOT EXISTS `ims_szxh_activeplus_robot_bind` (
  ...
  `tablename` varchar(30) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='机器人绑定表';
...
CREATE TABLE IF NOT EXISTS `ims_szxh_activeplus_service_user` (
  ...
  `sort` int(11) NOT NULL DEFAULT '0',
  `create_time` int(11) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=57 DEFAULT CHARSET=utf8 COMMENT='客服';
...
) ENGINE=MyISAM AUTO_INCREMENT=26 DEFAULT CHARSET=utf8 COMMENT='分享次数记录：可能不准确，以分享回调记录为主';
...
CREATE TABLE IF NOT EXISTS `ims_szxh_activeplus_transfers` (
  ...
  `create_time` int(11) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=1971 DEFAULT CHARSET=utf8 COMMENT='奖金记录';
...
) ENGINE=MyISAM AUTO_INCREMENT=20933 DEFAULT CHARSET=utf8 COMMENT='查看活动用户记录，根据时间记录，新纪录者增加活动浏览数1,120分钟内相同用户不记录';
...
CREATE TABLE IF NOT EXISTS `ims_szxh_log` (
  ...
  `create_time` int(11) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8 COMMENT='后台测试用';
...
ALTER TABLE `ims_szxh_activeplus_cate`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `ims_szxh_activeplus_order`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `ims_szxh_activeplus_register`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `ims_szxh_activeplus_robot`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `ims_szxh_activeplus_robot_bind`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `ims_szxh_activeplus_service_user`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `ims_szxh_activeplus_sharelog`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `ims_szxh_activeplus_transfers`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `ims_szxh_activeplus_view`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `ims_szxh_config`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `ims_szxh_log`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `ims_szxh_shield`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `ims_szxh_users`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `ims_szxh_activeplus_view`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=20933;
ALTER TABLE `ims_szxh_config`
